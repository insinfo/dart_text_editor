...
import 'dart:html'
    as html; // Importar dart:html com prefixo para evitar conflitos
  ...
  final doc = DocumentModel([
    ParagraphNode([
      TextRun(
          ...
          InlineAttributes()),
      TextRun(0, 'This is a new line with some bold text.',
          InlineAttributes(bold: true)),
      TextRun(0, ' And some italic text.', InlineAttributes(italic: true)),
      TextRun(
          0, ' And some underlined text.', InlineAttributes(underline: true)),
      TextRun(0, ' And some strikethrough text.',
          InlineAttributes(strikethrough: true)),
      TextRun(0, ' And some text with a background color.',
          InlineAttributes(backgroundColor: 'yellow')),
    ]),
    ParagraphNode([
